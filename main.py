...
<<<<<<< HEAD
    unet = UNet(in_chan=4, out_chan=4, embed_dim=128, n_attn_heads=8, dim_head=32, conv_init_chan=128, chan_mults=(1,2,2,4))
=======
    unet = UNet(in_chan=4, out_chan=4, embed_dim=128, n_attn_heads=16, dim_head=64, conv_init_chan=128, chan_mults=(1,2,4,4))
>>>>>>> parent of ecb3067 (reduce #heads, and head dimension)
